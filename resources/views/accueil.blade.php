...
<body class="container">
    ...
    <header>
        ...
        <div class="collapse navbar-collapse menu bg-danger" id="navbarNavDropdown">
            <ul class="navbar-nav">
            <li class="nav-item active bg ">
                <a class="nav-link lienB " href="">Accueil<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link lienB" id="actu" href="actualites">Actualités</a>
            </li>
            <li class="nav-item">
                <a class="nav-link lienB" href="vei_apprenants" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
